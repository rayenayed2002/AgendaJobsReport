...
file_format_counts = file_formats.value_counts().head(5)
...
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='this plots shows the values of -isanalyseEnd- .')
pdf.image('./teacherMyDataDetailPlot.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(110)
pdf.multi_cell(w=0, h=10, txt='and this shows the values of -isMyData- .')
pdf.add_page()
pdf.ln(15)
pdf.image('./analysePlagDatabaseDetailPlot.png',
         x = 18, y = 30, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='those are the values of -analysePlagDatabase- .')
pdf.image('./analyseRunDetailPlot.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(110)
pdf.multi_cell(w=0, h=10, txt='and those are the values of -analyseRun- .')
pdf.add_page()
pdf.ln(15)
print("80%")
...
pdf.ln(5)
pdf.multi_cell(w=0, h=10, txt='this table shows us the values of other data if -analyseRun- is true , maybe it can helps in some patterns.')
pdf.ln(10)
for i in range(len(whenAnalyseRunfalse)):
        ...
        pdf.cell(47, 10, feature4, border=1, ln=1, align='C')
pdf.ln(5)
pdf.multi_cell(w=0, h=10, txt='this table shows the values of data when -analyseRun- is False.')
pdf.ln(15)
...
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='we can see through this plot the most common documents names we have.')
...
pdf.image('./firstname.png',
          x = 18, y = 20, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='here we have the most common -Firstnames- in the collection.')
pdf.image('./lastname.png',
         x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt=' and here we have the most common -lastnames- .')
pdf.add_page()
pdf.ln(15)
pdf.image('./userfirstname.png',
          x = 18, y = 20, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='this plot is for -userFirstname-,it shows the most common userfirstnames.')
pdf.image('./userlastname.png',
         x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='and this is for the most common userlastnames.')
pdf.add_page()
pdf.ln(15)
pdf.image('./__v.png',
         x = 18, y = 20, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt=' this plot presents the value counts for - __v - variable.')
...
pdf.ln(90)
print("90%")
pdf.multi_cell(w=0, h=10, txt='this figure shows us the values of the variable -homoglyph- .')
pdf.image('./submitterValues.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='those are the most common submitters in the dataset.')
print("91%")
pdf.add_page()
pdf.ln(15)
pdf.image('./LibraryBool.png',
          x = 18, y = 20, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='this plot shows us the values of -libraryBool- variable.')
pdf.image('./company_counts.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
print("92%")
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='The plot provides insights into the occurrence of companies in the dataset, allowing for easy identification of the most common or prevalent companies.')
pdf.add_page()
pdf.ln(15)
print("93%")
...
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='By examining the -filename- plot, you can quickly identify the most common or popular file names in the dataset. This information can be useful for understanding naming conventions, identifying naming trends, or making decisions related to file management or organization.')
pdf.image('./isAnalysis.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='from here, we will examine the data in the archive array ,this plot shows the values of -isAnalysis- Variable.')
pdf.add_page()
pdf.ln(15)
pdf.image('./isDeleted.png',
          x = 18, y = 20, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='this plot is for -isDeleted- variable.')
print("94%")
pdf.image('./isDone.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='here we have the -isDone- value counts.')
pdf.add_page()
pdf.ln(15)
pdf.image('./isFirstTime.png',
          x = 18, y = 20, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='this plot shows us the variable -isFirstTime- values in archive.')
pdf.image('./isLibrary.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(100)
print("95%")
pdf.multi_cell(w=0, h=10, txt='here we have the values of -islibrary- .')
pdf.add_page()
pdf.ln(15)
pdf.image('./isPermanentlyDeleted.png',
          x = 18, y = 20, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='through this figure we can the values of -isPermanentlyDeleted- .')
pdf.image('./isPublic.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
print("96%")
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='and here we have the values of -is public- .')
print("97%")
pdf.add_page()
pdf.ln(15)
...
print("98%")
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='those are the values of -isTranslated- .')
pdf.image('./submitterArchive.png',
          x = 18, y = 150, w = 170, h = 70, type = 'PNG')
pdf.ln(100)
pdf.multi_cell(w=0, h=10, txt='and this plot shows us  the top submitters in the archive.')
print("99%")
pdf.add_page()
pdf.ln(15)
...
print("99,9%")
pdf.ln(90)
pdf.multi_cell(w=0, h=10, txt='this figure presents the values of -isPlagPrevent- variable.')
pdf.image('./size.png',
          x = 18, y = 130, w = 170, h = 100, type = 'PNG')
pdf.ln(130)
pdf.multi_cell(w=0, h=10, txt='finally we have this histogramme that shows the average value of the variable -size- in archive.')
print("100%")
pdf.output(f'./FinalVersion.pdf', 'F')